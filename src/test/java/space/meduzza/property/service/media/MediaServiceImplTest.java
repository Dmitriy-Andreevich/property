...
class MediaServiceImplTest {
    ...
    void writeAndDeleteTest() throws IOException {
        ...
        assertThat(loader.getResource(mediaService.getMediaLink(mediaEntity.getName())).getInputStream().readAllBytes())
                .isEqualTo(e1);
        ...
        assertThat(loader.getResource(mediaService.getMediaLink(mediaEntity.getName())).exists())
                .isFalse();
